...
const formSchema = z
  ...
  .refine(
    ...
    {
      message:
        "O horário de início não pode ser maior que o horário de término", // Exibe a mensagem de erro caso o horário de início seja maior que o horário de término
      path: ["availableToTime"], // Campo que exibe o erro
    },
  );
    ...
    <DialogContent>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <NumericFormat
                  ...
                  thousandSeparator="."
                  customInput={Input} // renderiza o input do shadcn/ui para ficar com o mesmo estilo
                  prefix="R$"
                />
              </FormItem>
            )}
          />
          {/* Disponibilidade */}
          {/* TODO: Alterar o campo para checkbox e armazenar no banco para dias alternados */}
          <FormField
            control={form.control}
            name="avaliableFromWeekDay"
            render={({ field }) => (
              <FormItem>
                <FormLabel>Dia de inicial da disponibilidade</FormLabel>
                <Select
                  onValueChange={field.onChange}
                  defaultValue={field.value}
                >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Hora inicial da disponibilidade</FormLabel>
                <Select
                  onValueChange={field.onChange}
                  defaultValue={field.value}
                >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Hora final da disponibilidade</FormLabel>
                <Select
                  onValueChange={field.onChange}
                  defaultValue={field.value}
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectGroup>
                      ...
                      <SelectItem value="00:00:00">00:00</SelectItem>
                    </SelectGroup>
                  </SelectContent>
                </Select>
              </FormItem>
